                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <div class="py-3">
                                ...
                                <div class="mt-1">
                                        ...
                                        <input id="product-name" name="name" type="text" value=""  class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Product Name">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="mt-1">
                                    ...
                                    <input id="product-price" name="price" type="number" value=""  class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Product Price">
                                </div>
                            </div>
                            <div>
